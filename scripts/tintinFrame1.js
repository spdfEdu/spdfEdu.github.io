...
//innerHTMLs & srcs & alts
{
 ...
 innerHTMLs.forEach(([target, content]) => {
  ...
  const srcs = [
    ...
    ['#ac',`${[git]}arabic/sm/${ttintin[slNo].eTitle.toLowerCase().split(' ').join('-')}-arabic.webp`,`${ttintin[slNo].fTitle}`]
  ]
...
crtDtlBox.innerHTML =`
<table class="book-detail" border="1"><tr class="info-row"><th class="info-label" colspan="3">${ttintin[slNo].eTitle}</th></tr><tr class="info-row"><td rowspan="5" width="40%"><img id="dimg" loading="lazy" class="d-cover" src="${[git]}english/sm/${ttintin[slNo].eTitle.toLowerCase().split(' ').join('-')}.webp"></td></tr><tr class="info-row"><th class="info-label">Creator</th><td class="info-data">Hergé</td></tr><tr class="info-row"><th class="info-label">Publish Year</th><td class="info-data">${ttintin[slNo].year}</td></tr><tr class="info-row"><th class="info-label">Volume</th><td class="info-data">${[slNo+1]}</td></tr><tr class="info-row"><th class="info-label">Languages Available</th><td class="info-data"><ul class="info-data-ul"><a href="#english"><li>English</li></a><a href="#bangla"><li>Bengali</li></a><a href="#french"><li>French</li></a><a href="#arabic"><li>Arabic</li></a></ul></td></tr><tr class="info-row"><th class="info-label">Genre</th><td class="info-data" colspan="2">Adventure / Action</td></tr><tr class="info-row"><th class="info-label">Category</th><td class="info-data" colspan="2"><em>Comics</em></td></tr><tr class="info-row"><th class="info-label">Series</th><td class="info-data" colspan="2"><em>The Adventures of Tintin</em></td></tr><tr class="info-row"><th class="info-label">Website Link</th><td class="info-data" colspan="2"><em><a class="link" href="https://bit.ly/tintinComics">bit.ly/tintinComics</a></em></td></tr><tr class="info-row"><td class="info-data" colspan="3"><h4>Title in</h4><table cellspacing="0"><tr><th class="t-info-label">English</th><td class="t-info-data">${ttintin[slNo].eTitle}</td></tr><tr><th class="t-info-label">French</th><td class="t-info-data">${ttintin[slNo].fTitle}</td></tr><tr><th class="t-info-label">Bengali</th><td class="t-info-data">${ttintin[slNo].bTitle}</td></tr><tr><th class="t-info-label">Hindi</th><td class="t-info-data">${ttintin[slNo].hTitle}</td></tr><tr><th class="t-info-label">Arabic</th><td class="t-info-data">${ttintin[slNo].aTitle}</td></tr>
</table></td></tr><tr class="info-row"><th class="info-label" >Followed by</th><td colspan="2" class="info-data" ><a class="link" href="/2022/02/${ttintin[slNo +1].eTitle.toLowerCase().split(" ").join("-").replace("'","")}.html">${ttintin[slNo +1].eTitle}</a> (${ttintin[slNo +1].year})</td></tr></table>`;
