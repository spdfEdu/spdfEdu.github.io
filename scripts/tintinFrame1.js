...
crtDtlBox.innerHTML =`
<table class="book-detail" border="1"><tr class="info-row"><th class="info-label center" colspan="3">${ttintin[slNo].eTitle}</th></tr><tr class="info-row"><td rowspan="5" width="40%"><img id="dimg" loading="lazy" class="d-cover" src="${[git]}english/sm/${ttintin[slNo].eTitle.toLowerCase().split(' ').join('-')}.webp"></td></tr><tr class="info-row"><th class="info-label">Creator</th><td class="info-data">Hergé</td></tr><tr class="info-row"><th class="info-label">Publish Year</th><td class="info-data">${ttintin[slNo].year}</td></tr><tr class="info-row"><th class="info-label">Languages Available</th><td class="info-data"><ul class="info-data-ul"><a href="#english"><li>English</li></a><a href="#bangla"><li>Bengali</li></a><a href="#french"><li>French</li></a><a href="#arabic"><li>Arabic</li></a></ul></td></tr><tr class="info-row"><th class="info-label">Category</th><td class="info-data"><em>The Adventures of Tintin</em></td></tr><tr class="info-row"><td class="info-data" colspan="3"><ul class="info-data-ul"><li><span class="info-label">English Title</span><span class="info-data">${ttintin[slNo].eTitle}</span></li><li><span class="info-label">Bengali Title</span><span class="info-data">${ttintin[slNo].bTitle}</span></li><li><span class="info-label">Hindi Title</span><span class="info-data">${ttintin[slNo].hTitle}</span></li><li><span class="info-label">French Title</span><span class="info-data">${ttintin[slNo].fTitle}</span></li><li><span class="info-label">Arabic Title</span><span class="info-data">${ttintin[slNo].aTitle}</span></li></ul></td></tr><tr class="info-row"><th class="info-label" >Followed by</th><td colspan="2" class="info-data" ><a class="link" href="/2022/02/${ttintin[slNo +1].eTitle.toLowerCase().split(" ").join("-").replace("'","")}.html">${ttintin[slNo +1].eTitle}</a> (${ttintin[slNo +1].year})</td></tr>
</table>`;
