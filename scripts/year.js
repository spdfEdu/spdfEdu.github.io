...
<div id="prepImgBox">
  <img id="prepImg" src="https://spdfedu.github.io/image/prepladder.jpg" alt="PrepLadder"/></div>
 <div id="prepHead">
 𝔹𝔼𝕊𝕋 ℙℝ𝔼ℙ𝕃𝔸𝔻𝔻𝔼ℝ 𝕆𝔽𝔽𝔼ℝ𝕊
</div><div id="offerDetails">
<div class="proff"><div class="profH">
    1st Proff</div><div class="cost">
...
<br><div id="share-box">
  ...
  <div class="button mail" onclick="location.href='mailto:?subject='+document.title+'&body=Content%20Url:%20'+xurl+'%0A%0A'+url;" href=''>
     ...
     <div class="item">
  <div class="button shr" onclick="share()"> <i id="shrSvg" class="sBs"></i>
  </div></div></div></div><br>
  <div id="teleBox">
